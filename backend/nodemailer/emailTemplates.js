...
<head>
  ...
  <title>PPA MCC: Verify Your Email</title>
</head>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Welcome to PPA MCC</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #007BFF, #0066CC); padding: 20px; text-align: center;">
    <h1 style="color: white; margin: 0;">Welcome to PPA MCC</h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); text-align: center;">
    <img src="https://mailsend-email-assets.mailtrap.io/fp58huyao64h7x5t87afrl3fj2op.jpg" alt="Welcome" style="max-width: 100%; border-radius: 5px; margin-bottom: 20px;" />
